...
| **Ensemble Weather** | Plots GFS / NAM / HRRR on shared axes so you can see how much the models disagree before trusting a forecast | [weather.jtamerius.com](https://weather.jtamerius.com) | [`apps/weather-app`](apps/weather-app/), [`apps/weather-pipeline`](apps/weather-pipeline/) |
